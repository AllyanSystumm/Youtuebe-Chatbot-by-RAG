...
# Display results
print(f"\n✅ Transcript successfully fetched and split.")
...
try:
    ...
    # print(f"✓ Response received from model: {response.model}")

except Exception as e:
    print(f"✗ Invalid token or API error: {e}")
...
print("⚠️  Keep this cell running to keep the app alive")